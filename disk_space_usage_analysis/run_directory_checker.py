...
class RunDirectoryChecker(AppLogger):
        ...
        for sample_directory_path in output.splitlines():
            ...
            if len(sample_directory_path_split) == 9:
                ...
                if run_directory_name not in self.run_counter:
                    ...
                    command = self.disk_space_usage_analysis.space_command + run_directory_path
                    command_output = os.popen(command).read()
    ...
    def export_run_directory_analysis_txt(self):
        with open(self.disk_space_usage_analysis.dir_cfg['runs_dir_space_analysis']['output_dir'] + 'run_dir_analysis_log.txt',
    ...
    def export_residual_run_directory_analysis_txt(self):
        with open(self.disk_space_usage_analysis.dir_cfg['runs_dir_space_analysis']['output_dir'] + 'residual_run_dir_analysis_log.txt',
                  mode='w') as analysis_txt_file:
